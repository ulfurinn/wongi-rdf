describe "the parsing collector" do
  ...
  it "should remap existing namespaces" do
    ...
    document.should_receive( :lookup ).ordered.with( "ns" ).and_return( URI.parse('http://ns/') )
    ...
    document.should_receive( :lookup ).ordered.with( "ns0" ).and_return( URI.parse('http://ns1/') )
    ...
    document.should_receive( :lookup ).ordered.with( "ns1" ).and_return( URI.parse('http://ns2/') )
